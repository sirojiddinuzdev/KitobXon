...
# Email sozlamalari
# Default: console (faqat logga chiqaradi). Haqiqiy yuborish uchun .env da
# EMAIL_BACKEND=django.core.mail.backends.smtp.EmailBackend va SMTP ma'lumotlarini bering.
...
DEFAULT_FROM_EMAIL = os.environ.get('DEFAULT_FROM_EMAIL', 'KitobXon <noreply@kitobhon.uz>')
