...
urlpatterns = [
    ...
    path('istaklar/', views.istaklar, name='istaklar'),
    path('istaklar/<int:istak_id>/ochirish/', views.istak_ochirish, name='istak-ochirish'),
    path('izlanayotgan/', views.izlanayotgan, name='izlanayotgan'),
    path('tarix/', views.tarix, name='tarix'),
